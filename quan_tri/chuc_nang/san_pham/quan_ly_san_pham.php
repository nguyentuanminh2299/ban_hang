...
<?php 
	...
	{
		$tv="select count(*) from san_pham where loai_sp='$id_menu' ";
	}
	$tv_1=mysqli_query($conn,$tv);
	...
	{
		$tv="select id,ten,gia,hinh_anh from san_pham where loai_sp='$id_menu' order by id desc limit $vtbd,$so_dong_tren_mot_trang";
	}
	$tv_1=mysqli_query($conn,$tv);
?>
